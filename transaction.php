            ...
            <div class="rcontent">
                ...
                <div id="data">
                    ...
                    if (isset($_POST['cancel'])) {
                        // Perform cancel action (e.g., truncate table)
                        mysqli_query($conn, "TRUNCATE TABLE transaction");
                    }
                    ?>
                    <span id="transalert"></span>
                    <form action="sell.php" method="post" onsubmit="return validate()">
                        <table border="0" style="width:100%">
                            <tr>
                                <td style="vertical-align:top; padding:10px; width:40%">
                                    <table style="margin-left:auto; margin-right:auto">
                                        <tr>
                                            <td>Product ID:</td>
                                            <td><input type="text" id='prodid' name="prodid" onchange="getprice('id', this.value)" /></td>
                                        </tr>
                                        <tr>
                                            <td>Product Name:</td>
                                            <td><input type="text" id='prodname' onchange="getprice('name', this.value)" name="prodname" /></td>
                                        </tr>
                                        <tr>
                                            <td>Quantity:</td>
                                        ...
                                        <tr>
                                            <td>PromoCode:</td>
                                            <td><input type="text" id='discount' name="discount" size="6" /></td>
                                        </tr>
                                        <tr>
                                            <td>Customer Id:</td>
                                            <td><input type="text" id='cid' name="cid" size="6" placeholder="0 for Guest" /></td>
                                        </tr>
                                    </table>
                                </td>
                            ...
                            <tr>
                                <td><input type="submit" name="submit" value="Pay & Print" /></td>
                                <td>
                                    <input type="button" value="Cancel" name="cancel" onclick="cancelTransaction()" />
                                </td>
                            </tr>
                        </table>
                    </form>
...
<script>
    function cancelTransaction() {
        fetch("transaction.php?cancel=1")
